...
favoriteArr = JSON.parse(localStorage.getItem("favoriteList")) || [];
...
function getMovieDetails() {
    ...
    for ( var i = 0; i <favoriteArr.length; i++) {
        var movieQuery = "https://api.themoviedb.org/3/movie/" + favoriteArr[i] + "?api_key=7ea50f67c90ee9445e3909943a9fd7a9&language=en-US"
        ...
        .then(function(data){
            ...
            favoriteContainer.append(cardColEl);
